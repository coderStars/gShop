            ...
            <div class="chooseArea">
              ...
              <dl v-for="(spuSale, index) in spuSaleAttrList" :key="spuSale.id">
                ...
                <dd
                  ...
                  v-for="(spuAttr, index) in spuSale.spuSaleAttrValueList"
                  :key="spuAttr.id"
                  @click="changeType(spuAttr,spuSale.spuSaleAttrValueList)"
                >{{spuAttr.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
export default {
  ...
  methods: {
    ...
    changeType(spuAttr, spuSaleAttrValueList) {
    ...
    async addCart() {
      try{
        let result = await this.$store.dispatch('addToCart',{skuId:this.skuInfo.id,skuNum:this.skuNum})
        alert('添加购物车成功!! 即将跳转至购物车')
